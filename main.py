...
class Application(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.radio1 = tk.Radiobutton(self, text="Entry Level", variable=self.level, value="Entry Level",
                                     font=("Arial", 16), fg="navy")
        self.radio2 = tk.Radiobutton(self, text="Mid Level", variable=self.level, value="Mid Level", font=("Arial", 16),
                                     fg="navy")
        ...
        self.submit = tk.Button(self, text="Next", command=self.submit_choice, font=("Arial", 16), bg="navy",
                                fg="white")
    ...
    def submit_choice(self):
        ...
        tk.Label(self, text="Fill in client information (if not applicable, leave empty):", font=("Arial", 18), fg="navy").grid(row=0, column=0, padx=10, pady=10, sticky=tk.W)

        # create new widgets for the next form
        tk.Label(self, text="Name:", font=("Arial", 16), fg="navy").grid(row=1, column=0, padx=10, pady=10, sticky=tk.W)
        self.nameB = tk.Text(self, height=1, width=30, font=("Arial", 18), bg="#F9F8F8")
        self.nameB.grid(row=2, column=0, padx=10, pady=5)

        tk.Label(self, text="City:", font=("Arial", 16), fg="navy").grid(row=3, column=0, padx=10, pady=10, sticky=tk.W)
        self.cityB = tk.Text(self, height=1, width=30, font=("Arial", 18), bg="#F9F8F8")
        self.cityB.grid(row=4, column=0, padx=10, pady=5)

        tk.Label(self, text="State:", font=("Arial", 16), fg="navy").grid(row=5, column=0, padx=10, pady=10,
                                                                          sticky=tk.W)
        self.stateB = tk.Text(self, height=1, width=30, font=("Arial", 18), bg="#F9F8F8")
        self.stateB.grid(row=6, column=0, padx=10, pady=5)

        tk.Label(self, text="Zip Code:", font=("Arial", 16), fg="navy").grid(row=7, column=0, padx=10, pady=10,
                                                                             sticky=tk.W)
        self.zip_codeB = tk.Text(self, height=1, width=30, font=("Arial", 18), bg="#F9F8F8")
        self.zip_codeB.grid(row=8, column=0, padx=10, pady=5)

        tk.Label(self, text="Phone:", font=("Arial", 16), fg="navy").grid(row=9, column=0, padx=10, pady=10,
                                                                          sticky=tk.W)
        self.phoneB = tk.Text(self, height=1, width=30, font=("Arial", 18), bg="#F9F8F8")
        self.phoneB.grid(row=10, column=0, padx=10, pady=5)

        tk.Label(self, text="Email:", font=("Arial", 16), fg="navy").grid(row=11, column=0, padx=10, pady=10,
                                                                          sticky=tk.W)
        self.emailB = tk.Text(self, height=1, width=30, font=("Arial", 18), bg="#F9F8F8")
        self.emailB.grid(row=12, column=0, padx=10, pady=5)

        tk.Label(self, text="Job title:", font=("Arial", 16), fg="navy").grid(row=13, column=0, padx=10, pady=10, sticky=tk.W)
        self.jobB = tk.Text(self, height=1, width=30, font=("Arial", 18), bg="#F9F8F8")
        self.jobB.grid(row=14, column=0, padx=10, pady=5)

        tk.Label(self, text="Skills:", font=("Arial", 16), fg="navy").grid(row=15, column=0, padx=10, pady=10,
                                                                           sticky=tk.W)
        self.skillsB = tk.Text(self, height=3, width=30, font=("Arial", 18), bg="#F9F8F8", wrap="word")
        self.skillsB.grid(row=16, column=0, padx=10, pady=5)
        scrollb = tk.Scrollbar(self, command=self.skillsB.yview)
        self.skillsB['yscrollcommand'] = scrollb.set
        scrollb.grid(row=16, column=1, pady=5, sticky=tk.NS)

        tk.Label(self, text="Education:", font=("Arial", 16), fg="navy").grid(row=17, column=0, padx=10, pady=10,
                                                                              sticky=tk.W)
        self.educationB = tk.Text(self, height=3, width=30, font=("Arial", 18), bg="#F9F8F8", wrap="word")
        self.educationB.grid(row=18, column=0, padx=10, pady=5)
        scrollb = tk.Scrollbar(self, command=self.educationB.yview)
        self.educationB['yscrollcommand'] = scrollb.set
        scrollb.grid(row=18, column=1, pady=5, sticky=tk.NS)

        # create submit button for the next form
        self.submit2 = tk.Button(self, text="Next", command=self.submit_choice2, font=("Arial", 16), bg="navy",
                                 fg="white")
        self.submit2.grid(row=19, column=0, padx=10, pady=20, sticky=tk.N, ipadx=50)
    ...
    def experience_choice(self):
        # create label
        self.label = tk.Label(self, text="Specify the number of the client's experiences", font=("Arial", 18), fg="navy")
        self.label.grid(row=0, column=0, padx=10, pady=10, sticky=tk.W)

        # create radio buttons
        self.choice = tk.IntVar()
        self.radio1 = tk.Radiobutton(self, text="1 Experience", variable=self.choice, value=1, font=("Arial", 16), fg="navy")
        self.radio2 = tk.Radiobutton(self, text="2 Experiences", variable=self.choice, value=2, font=("Arial", 16), fg="navy")
        self.radio3 = tk.Radiobutton(self, text="3 Experiences", variable=self.choice, value=3, font=("Arial", 16), fg="navy")
        self.radio4 = tk.Radiobutton(self, text="4 Experiences", variable=self.choice, value=4, font=("Arial", 16), fg="navy")
        ...
        self.submit3 = tk.Button(self, text="Next", command=self.submit_choice3, font=("Arial", 16), bg="navy",
                                 fg="white")
    ...
    def experience(self):
        tk.Label(self, text="Fill in experience information (leave empty if not applicable), press next to go to the "
                 ...
                 font=("Arial", 20), fg="navy").grid(row=0, column=0, padx=10, pady=10, sticky=tk.W)

        tk.Label(self, text="Company Name:", font=("Arial", 18), fg="navy").grid(row=1, column=0, padx=10, pady=10, sticky=tk.W)
        self.comp = tk.Text(self, height=1, width=30, font=("Arial", 18), bg="#F9F8F8")
        self.comp.grid(row=2, column=0, padx=10, pady=5)

        tk.Label(self, text="Job Name:", font=("Arial", 18), fg="navy").grid(row=3, column=0, padx=10, pady=10, sticky=tk.W)
        self.job = tk.Text(self, height=1, width=30, font=("Arial", 18), bg="#F9F8F8")
        self.job.grid(row=4, column=0, padx=10, pady=5)

        tk.Label(self, text="Location:", font=("Arial", 18), fg="navy").grid(row=5, column=0, padx=10, pady=10, sticky=tk.W)
        self.location = tk.Text(self, height=1, width=30, font=("Arial", 18), bg="#F9F8F8")
        self.location.grid(row=6, column=0, padx=10, pady=5)

        tk.Label(self, text="Dates:", font=("Arial", 18), fg="navy").grid(row=7, column=0, padx=10, pady=10, sticky=tk.W)
        self.dates = tk.Text(self, height=1, width=30, font=("Arial", 18), bg="#F9F8F8")
        self.dates.grid(row=8, column=0, padx=10, pady=5)

        tk.Label(self, text="Company Description:", font=("Arial", 18), fg="navy").grid(row=9, column=0, padx=10, pady=10,
                                                                             sticky=tk.W)
        self.compDesc = tk.Text(self, height=3, width=30, font=("Arial", 18), bg="#F9F8F8", wrap="word")
        self.compDesc.grid(row=10, column=0, padx=10, pady=5)

        tk.Label(self, text="Job Description:", font=("Arial", 18), fg="navy").grid(row=11, column=0, padx=10, pady=10,
                                                                         sticky=tk.W)
        self.jobDesc = tk.Text(self, height=3, width=30, font=("Arial", 18), bg="#F9F8F8", wrap="word")
        ...
        tk.Label(self, text="Achievements:", font=("Arial", 18), fg="navy").grid(row=13, column=0, padx=10, pady=10, sticky=tk.W)
        self.achievements = tk.Text(self, height=3, width=30, font=("Arial", 18), bg="#F9F8F8", wrap="word")
        ...
        self.submit4 = tk.Button(self, text="Next", command=self.submit_choice4, font=("Arial", 16), bg="navy",
                                 fg="white")
        self.submit4.grid(row=15, column=0, padx=10, pady=10, sticky=tk.N, ipadx=50)

        self.submit5 = tk.Button(self, text="Create Resume", command=self.resume_create, font=("Arial", 16), bg="navy",
                                 fg="white")
    ...
    def resume_create(self):
        ...
        self.adjustments = tk.Text(self, height=3, width=80, font=("Arial", 18), bg="#F9F8F8", wrap="word")
        ...
        self.adjust = tk.Button(self, text="Rewrite", command=self.rewrite_resume, font=("Arial", 16), bg="navy",
                                 fg="white")
        self.adjust.grid(row=4, column=0, padx=10, pady=10, sticky=tk.W, ipadx=50)

        # create button to save the resume to a file
        self.save = tk.Button(self, text="Save", command=self.save_resume, font=("Arial", 16), bg="navy",
                                 fg="white")
